            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  placeholder="dbrys2115@gmail.com"
                  disabled={isSending}
                  className="flex-1"
                />
...
SMTP_FROM=your-email@gmail.com`}
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground">
                Restart your Next.js development server or Docker container to apply the new settings.
              </p>
            </div>
          </div>
        </CardContent>
...
function ConfigItem({
  ...
  const displayValue = value || (isSecret ? "Not configured" : "Not set");
